...
[![Ruby](https://img.shields.io/badge/Ruby-4.0.4-red.svg)](https://www.ruby-lang.org)
...
FlyWeight requires Ruby 4.0.4, PostgreSQL, and Redis. (If you use Homebrew,
...
```
backend: cd Backend && rvm 4.0.4@flyweight exec rails server
frontend: cd Frontend && yarn dev
anycable: cd Backend && rvm 4.0.4@flyweight exec anycable
ws: cd Backend && rvm 4.0.4@flyweight exec bin/anycable-go --port=8080
```
