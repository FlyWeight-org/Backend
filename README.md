...
```
backend: cd Backend && rvm 3.4.6@flyweight exec rails server
frontend: cd Frontend && yarn dev
jobs: cd Backend && rvm 3.4.6@flyweight exec bundle exec good_job start
anycable: cd Backend && rvm 3.4.6@flyweight exec anycable
ws: cd Backend && rvm 3.4.6@flyweight exec bin/anycable-go --port=8080
```
