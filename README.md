...
```
backend: cd Backend && rvm 3.4.8@flyweight exec rails server
frontend: cd Frontend && yarn dev
jobs: cd Backend && rvm 3.4.8@flyweight exec bundle exec good_job start
anycable: cd Backend && rvm 3.4.8@flyweight exec anycable
